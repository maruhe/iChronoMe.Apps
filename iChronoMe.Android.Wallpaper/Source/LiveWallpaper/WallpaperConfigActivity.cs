...
{
    [Activity(Label = "@string/wallpaper_title_clock_analog", Name = "me.ichrono.droid.Wallpaper.WallpaperConfigActivity", Exported = true, Theme = "@style/AppTheme")]//, LaunchMode = LaunchMode.SingleTask, TaskAffinity = "", NoHistory = true)]
