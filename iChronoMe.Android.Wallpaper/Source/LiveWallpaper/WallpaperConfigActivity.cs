...
{
    [Activity(Label = "@string/wallpaper_title_clock_analog", Name = "me.ichrono.droid.LiveWallpapers.WallpaperConfigActivity", Theme = "@style/AppTheme.NoActionBar")]//, LaunchMode = LaunchMode.SingleTask, TaskAffinity = "", NoHistory = true)]
